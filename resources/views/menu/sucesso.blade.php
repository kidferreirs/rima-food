...
<div class="max-w-md mx-auto bg-white min-h-screen pb-10">
    ...
    <div class="relative">
        ...
        <div class="absolute -bottom-8 left-6 w-20 h-20 bg-white rounded-3xl shadow-lg flex items-center justify-center overflow-hidden">
    ...
    <div class="px-6 pt-12">
        ...
        <div class="mt-6 space-y-3">
            ...
            <button disabled
               class="w-full border font-bold rounded-2xl py-4 text-slate-400 bg-slate-50">
                Acompanhar Pedido em breve
            </button>
        </div>

        <p class="text-center text-xs text-slate-400 mt-8">
            Desenvolvido por Rimatech
        </p>
    </div>
